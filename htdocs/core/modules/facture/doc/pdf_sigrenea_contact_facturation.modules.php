...
/**
 *  \file       htdocs/core/modules/facture/doc/pdf_sigrenea_contact_facturation.modules.php
 *  \ingroup    facture
 *  \brief      File of class to generate customers invoices from sigrenea_contact_facturation model
 */
...
/**
 *	Class to manage PDF invoice template sigrenea_contact_facturation
 */
class pdf_sigrenea_contact_facturation extends ModelePDFFactures
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "Sigrenea contact facturation";
		$this->description = $langs->trans('PDFSigreneaContactFacturationDescription');
