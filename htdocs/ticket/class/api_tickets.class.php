...
class Tickets extends DolibarrApi
{
	...
	/** START BACKPORT KN : https://github.com/Dolibarr/dolibarr/pull/39062 */
	/**
	...
	public function post($request_data = null)
	{
		...
		/** START SPÉ KN - create the ticket without firing TICKET_CREATE (notrigger=1) so the payload contacts are linked before the creation notification is sent */
		...
		/** START SPÉ KN - contacts are now linked: fire TICKET_CREATE so the creation notification reaches the ticket contacts */
