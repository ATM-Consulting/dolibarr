	...
	public function setReopen(User $user): int
	{
		if (in_array($this->status, [1, 2, 3, 4, 5, 6, 7, 9])) {
			if ($this->status == 1) {
				...
				// @ATM-PATCH BEGIN DA028615 — backport of Dolibarr core PR #40032 (reopen of a fully received purchase order), remove once merged upstream in 23.0
